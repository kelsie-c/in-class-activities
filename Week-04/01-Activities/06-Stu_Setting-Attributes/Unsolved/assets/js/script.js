...
var changeh = document.querySelectorAll('h4');

for (let i = 0; i < changeh.length; i++) {
    changeh[i].setAttribute("style", "color: blue; font-size: 30px; font-weight: bold; ");
}

var changeTitle = document.querySelector("h1");
changeTitle.setAttribute("style", "padding-left: 10px; margin: 0;");