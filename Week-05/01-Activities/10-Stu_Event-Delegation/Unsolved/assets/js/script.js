...
// TODO: Use event delegation and add an event listener to `shoppingListEl` to listen for a click 
// event on any element with a class of `.delete-item-btn` and execute the function created above
